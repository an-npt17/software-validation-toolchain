...
#define _nstates2	14	/* no_deadlock */
#define minseq2	27
#define maxseq2	39
...
#define _nstates0	17	/* Philosopher */
#define minseq0	0
#define maxseq0	15
...
#define Air1	(sizeof(P1) - Offsetof(P1, _2_4_i) - 1*sizeof(uchar))
