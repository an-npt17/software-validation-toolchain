...
#define _nstates3	14	/* progress */
#define minseq3	32
#define maxseq3	44
#define _endstate3	13

#define _nstates2	11	/* mutex */
#define minseq2	22
#define maxseq2	31
#define _endstate2	10

#define _nstates1	12	/* Process1 */
#define minseq1	11
#define maxseq1	21
#define _endstate1	11

#define _nstates0	12	/* Process0 */
#define minseq0	0
#define maxseq0	10
...
#define PProcess1	((P1 *)_this)
typedef struct P1 { /* Process1 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#define PProcess0	((P0 *)_this)
typedef struct P0 { /* Process0 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
